  ...
  return (
    <>
      <div>
        ...
        <div>
          <h1 className='text-[40px] mt-35 welcomeBack '>Enter your email</h1>
        </div>
        ...
        <p className='text-[19px] mt-6'> Already have an account? <span className='text-blue-400'> <Link to="/">login</Link> </span></p>
        <br />
